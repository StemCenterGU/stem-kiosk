...
const STYLE_ID = "mission-quiz-style";
...
function ensureStyles() {
  ...
  style.textContent = `
    ...
    .mission-quiz__hud-item span {
      font-size: 0.9rem;
      color: #bbf7d0;
    }
    .mission-quiz__hud-item strong {
      font-size: 1.4rem;
    }
    .mission-quiz__question {
      display: grid;
      gap: 18px;
    }
    .mission-quiz__question-info {
      display: flex;
      gap: 12px;
      justify-content: space-between;
      margin-bottom: 8px;
    }
    .mission-quiz__category {
    ...
    .mission-quiz__difficulty.easy {
      background: rgba(34, 197, 94, 0.2);
      color: #86efac;
    }
    .mission-quiz__difficulty.medium {
      background: rgba(245, 158, 11, 0.2);
      color: #fcd34d;
    }
    .mission-quiz__difficulty.hard {
      background: rgba(239, 68, 68, 0.2);
      color: #fca5a5;
    }
    .mission-quiz__prompt {
      font-size: clamp(1.3rem, 2vw + 1rem, 1.8rem);
      line-height: 1.4;
    }
    .mission-quiz__options {
      display: grid;
      gap: 12px;
    }
    .mission-quiz__option {
      padding: 14px 18px;
      border-radius: 14px;
      ...
      text-align: left;
      cursor: pointer;
      transition: transform 0.16s ease, border 0.16s ease, background 0.2s ease;
    }
    .mission-quiz__option:active {
      transform: scale(0.97);
    }
    .mission-quiz__option[data-state="correct"] {
      border-color: rgba(74, 222, 128, 0.9);
      background: rgba(34, 197, 94, 0.25);
      color: #ecfdf3;
    }
    .mission-quiz__option[data-state="wrong"] {
      border-color: rgba(248, 113, 113, 0.9);
      background: rgba(248, 113, 113, 0.2);
      color: #fee2e2;
    }
    .mission-quiz__telemetry {
    ...
    .mission-quiz__log-entry {
      background: rgba(74, 222, 128, 0.12);
      border-radius: 12px;
      padding: 12px;
    }
    .mission-quiz__log-entry strong {
      display: block;
      color: #bbf7d0;
    }
    .mission-quiz__controls {
      display: flex;
      justify-content: space-between;
      align-items: center;
      gap: 16px;
    ...
    .mission-quiz__overlay.active {
      display: grid;
    }
    .mission-quiz__overlay h3 {
      margin: 0;
